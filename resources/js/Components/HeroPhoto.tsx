...
const badges = [
    { label: 'Laravel', style: { top: '5%', left: '-20%', animationDelay: '0s' } },
    { label: 'React', style: { top: '38%', left: '-24%', animationDelay: '0.6s' } },
    { label: 'TypeScript', style: { bottom: '18%', left: '-18%', animationDelay: '1.2s' } },
    { label: 'MySQL', style: { top: '10%', right: '-18%', animationDelay: '0.3s' } },
    { label: 'PHP', style: { bottom: '28%', right: '-16%', animationDelay: '0.9s' } },
];
